...
import { S as L } from "./erc-721-standard-961fbe42.browser.esm-711a8851.js";
import { P as B } from "./thirdweb-checkout-fbd7e98d.browser.esm-56c824d0.js";
import { l as i, R as z } from "./index-dd74b233.js";
...
const l = class l extends L {
  constructor(t, r, a) {
    ...
    (this.abi = A.parse(o || [])),
      ...
      (this.roles = new R(this.contractWrapper, l.contractRoles)),
      (this.royalties = new S(this.contractWrapper, this.metadata)),
