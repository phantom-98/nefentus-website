import { y as I, S as k, $ } from "./index-dd74b233.js";
import {
  f as d,
  b as l,
  _ as y,
...
import {
  ...
  U as L,
  S as O,
} from "./errors-d961f852.browser.esm-f0b83d2d.js";
...
const Y = new Set([1, 137, 10, 42161, 56]),
  j = "eip155",
  x = "wagmi.requestedChains",
    ...
    super({ ...i, options: { isNewChainsStale: !0, ...i.options } }),
      ...
      (this.filteredChains =
        this.chains.length > 50
          ? this.chains.filter((e) => Y.has(e.chainId))
          : this.chains);
  }
  async connect() {
    var a;
...
async function B() {
  const {
      ...
      () => import("./index.es-b67ea90c.js"),
      [
        "assets/index.es-b67ea90c.js",
        "assets/index-dd74b233.js",
        "assets/index-074740b3.css",
        "assets/events-34b8a28b.js",
        "assets/index-0b7da92f.js",
        "assets/index-e5cf03ca.js",
        "assets/index-e651aa00.css",
        "assets/constants-ac5fb9cc.js",
        "assets/hoist-non-react-statics.cjs-41d71acf.js",
        "assets/Helmet-4c7ebf64.js",
...
async function g(h) {
  await s(this, u).setItem(x, JSON.stringify(h));
}
async function F() {
  const h = await s(this, u).getItem(x);
...
function V() {
  ...
  return s(this, n)
    ? ((a =
        (e = (i = s(this, n).session) == null ? void 0 : i.namespaces[j]) ==
        null
          ? void 0
          : e.chains) == null
        ? void 0
...
function G() {
  var i, e;
  return s(this, n)
    ? ((e = (i = s(this, n).session) == null ? void 0 : i.namespaces[j]) == null
        ? void 0
        : e.methods) ?? []
    : [];
}
