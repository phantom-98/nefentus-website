...
function xt(n) {
  return (t, e) => (e !== void 0 ? pt(n, t, e) : ut(n, t));
}
/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */ var k;
((k = window.HTMLSlotElement) === null || k === void 0
  ? void 0
  : k.prototype.assignedElements) != null;
/**
 * @license
...
const $t = (n) => new nt(typeof n == "string" ? n : n + "", void 0, q),
  Ut = (n, ...t) => {
    const e =
      n.length === 1
        ? n[0]
...
let y = class extends HTMLElement {
  ...
  requestUpdate(t, e, i) {
    let s = !0;
    t !== void 0 &&
      (((i = i || this.constructor.getPropertyOptions(t)).hasChanged || ot)(
        this[t],
        e,
      )
  ...
  performUpdate() {
    ...
    this.hasUpdated,
      this._$Ei &&
        (this._$Ei.forEach((s, r) => (this[r] = s)), (this._$Ei = void 0));
    let e = !1;
    const i = this._$AL;
    try {
...
(y[I] = !0),
  ...
  F == null || F({ ReactiveElement: y }),
  ((M = N.reactiveElementVersions) !== null && M !== void 0
    ? M
...
const T = window,
  g = T.trustedTypes,
  G = g ? g.createPolicy("lit-html", { createHTML: (n) => n }) : void 0,
  V = "$lit$",
  ...
  lt = Array.isArray,
  At = (n) =>
    lt(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function",
  z = `[ 	
\f\r]`,
  S = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,
  Q = /-->/g,
  ...
  for (let a = 0; a < e; a++) {
      ...
      (p = o.lastIndex),
        o === S
          ? d[1] === "!--"
            ...
            ? (o = X)
            : d[2] !== void 0
            ? (ht.test(d[2]) && (s = RegExp("</" + d[2], "g")), (o = _))
            : d[3] !== void 0 && (o = _)
          : o === _
          ? d[0] === ">"
            ? ((o = s ?? S), (c = -1))
    ...
    r +=
      o === S
        ? l + ft
        : c >= 0
        ? (i.push(h), l.slice(0, c) + V + l.slice(c) + v + $)
        : l + v + (c === -2 ? (i.push(void 0), a) : $);
  }
  ...
  constructor({ strings: t, _$litType$: e }, i) {
    ...
    for (; (s = f.nextNode()) !== null && l.length < a; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes()) {
          ...
          for (const p of s.getAttributeNames())
            if (p.endsWith(V) || p.startsWith(v)) {
              const $ = d[o++];
              if ((c.push(p), $ !== void 0)) {
                const ct = s.getAttribute($.toLowerCase() + V).split(v),
                  P = /([.?@])?(.*)/.exec($);
                l.push({
                  type: 1,
                  index: r,
        ...
        if (s.data === rt) l.push({ type: 2, index: r });
        else {
          let c = -1;
  ...
  u(t) {
    ...
    for (; h !== void 0; ) {
      if (a === h.index) {
        let d;
        h.type === 2
          ? (d = new x(o, o.nextSibling, this, t))
          : h.type === 1
          ? (d = new h.ctor(o, h.name, h.strings, this, t))
          : h.type === 6 && (d = new wt(o, this, t)),
          this._$AV.push(d),
          (h = s[++l]);
      }
...
class x {
    ...
    const { values: i, _$litType$: s } = t,
      r =
        typeof s == "number"
          ? this._$AC(t)
          : (s.el === void 0 &&
              (s.el = C.createElement(dt(s.h, s.h[0]), this.options)),
            s);
    if (((e = this._$AH) === null || e === void 0 ? void 0 : e._$AD) === r)
      this._$AH.v(i);
    else {
      const o = new gt(r, this),
        a = o.u(this.options);
  ...
  T(t) {
    ...
    for (const r of t)
      s === e.length
        ? e.push((i = new x(this.k(b()), this.k(b()), this, this.options)))
        : (i = e[s]),
        i._$AI(r),
        s++;
  ...
  _$AI(t, e = this, i, s) {
    ...
    if (r === void 0)
      ...
      for (t = r[0], l = 0; l < r.length - 1; l++)
        (h = E(this, a[i + l], e, l)),
          h === m && (h = this._$AH[l]),
          o || (o = !w(h) || h !== this._$AH[l]),
          h === u ? (t = u) : t !== u && (t += (h ?? "") + r[l + 1]),
          (this._$AH[l] = h);
    }
    o && !s && this.j(t);
  }
...
const it = T.litHtmlPolyfillSupport;
it == null || it(C, x),
  ((L = T.litHtmlVersions) !== null && L !== void 0
    ? L
    : (T.litHtmlVersions = [])
  ).push("2.8.0");
const Ct = (n, t, e) => {
