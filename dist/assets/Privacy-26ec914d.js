import { r as o, j as e } from "./index-dd74b233.js";
import { H as i } from "./Helmet-4c7ebf64.js";
const a = "_section_5cp1o_1",
  s = "_leftContent_5cp1o_22",
  t = { section: a, leftContent: s },
  r = () => (
    o.useState(0),
    e.jsxs("div", {
      className: `container ${t.section}`,
      children: [
        e.jsx("h2", { children: "Privacy Policy:" }),
        e.jsx("div", {
          className: `${t.body}`,
          children: e.jsxs("div", {
            className: t.content,
            children: [
              e.jsx("h3", { children: "1. An overview of data protection" }),
              e.jsx("h4", { children: "General information" }),
              e.jsx("p", {
                className: t.description,
                children:
                  "The following information will provide you with an easy to navigate overview of what will happen with your personal data when you visit this website. The term “personal data” comprises all data that can be used to personally identify you. For detailed information about the subject matter of data protection, please consult our Data Protection Declaration, which we have included beneath this copy.",
              }),
              e.jsx("h4", { children: "Data recording on this website" }),
              e.jsx("p", {
                children:
              ...
              e.jsx("h4", { children: "How do we record your data?" }),
              e.jsx("p", {
                children:
              ...
              e.jsx("h4", {
                children: "Analysis tools and tools provided by third parties",
              }),
              e.jsx("p", {
                children:
              ...
              e.jsx("h3", {
                children: "2. General information and mandatory information",
              }),
              e.jsx("h4", { children: "Data protection" }),
              e.jsx("p", {
                children:
              ...
              e.jsx("h4", {
                children: "Right to demand processing restrictions",
              }),
              e.jsx("p", {
                children:
              ...
              e.jsx("h4", { children: "Rejection of unsolicited e-mails" }),
              e.jsx("p", {
                children:
                  "We herewith object to the use of contact information published in conjunction with the mandatory information to be provided in section “Information Required by Law” to send us promotional and information material that we have not expressly requested. The operators of this website and its pages reserve the express right to take legal action in the event of the unsolicited sending of promotional information, for instance via SPAM messages.",
              }),
              e.jsx("h3", { children: "3. Recording of data on this website" }),
              e.jsx("h4", { children: "Cookies" }),
              e.jsx("p", {
                children:
              ...
              e.jsx("h4", { children: "Server log files" }),
              e.jsx("p", {
                children:
                  "The provider of this website and its pages automatically collects and stores information in so-called server log files, which your browser communicates to us automatically. The information comprises:",
              }),
              e.jsx("p", { children: "The type and version of browser used" }),
              e.jsx("p", { children: "The used operating system" }),
              e.jsx("p", { children: "Referrer URL" }),
              e.jsx("p", {
                children: "The hostname of the accessing computer",
              }),
              e.jsx("p", { children: "The time of the server inquiry" }),
              e.jsx("p", { children: "The IP address" }),
              e.jsx("p", {
                children: "This data is not merged with other data sources.",
              }),
              e.jsx("p", {
                children:
                  "This data is recorded on the basis of Art. 6 Sect. 1 lit. f GDPR. The operator of the website has a legitimate interest in the technically error free depiction and the optimization of the operator’s website. In order to achieve this, server log files must be recorded.",
              }),
              e.jsx("h4", { children: "Contact form" }),
              e.jsx("p", {
                children:
              ...
              e.jsx("h4", { children: "Request by e-mail, telephone or fax" }),
              e.jsx("p", {
                children:
              ...
              e.jsx("h4", { children: "Registration on this website" }),
              e.jsx("p", {
                children:
              ...
              e.jsx("h3", { children: "4. Social media" }),
              e.jsx("h4", { children: "LinkedIn plug-in" }),
              e.jsx("p", {
                children:
              ...
              e.jsx("h3", { children: "5. Analysis tools and advertising" }),
              e.jsx("h4", { children: "Google Analytics" }),
              e.jsx("p", {
                children:
              ...
              e.jsx("h4", { children: "IP anonymization" }),
              e.jsx("p", {
                children:
              ...
              e.jsx("h4", { children: "Browser plug-in" }),
              e.jsx("p", {
                children:
              ...
              e.jsx("h4", { children: "Contract data processing" }),
              e.jsx("p", {
                children:
                  "We have executed a contract data processing agreement with Google and are implementing the stringent provisions of the German data protection agencies to the fullest when using Google Analytics.",
              }),
              e.jsx("h4", { children: "Archiving period" }),
              e.jsx("p", {
                children:
              ...
              e.jsx("h4", { children: "IONOS Web Analytics" }),
              e.jsx("p", {
                children:
                  "This website uses IONOS Web Analytics analysis services. The provider of these services is 1&1 IONOS SE, Elgendorfer Straße 57, 56410 Montabaur, Germany. In conjunction with the performance of analyses by IONOS, it is possible to e.g. analyze the number of visitors and their behavior patterns during visits (e.g. number of pages accessed, duration of their visits to the website, percentage of aborted visits), visitor origins (i.e. from which site does the visitor arrive at our site), visitor locations as well as technical data (browser and session of operating system used). For these purposes, IONOS archives in particular the following data:",
              }),
              e.jsx("p", { children: "Referrer (previously visited website)" }),
              e.jsx("p", { children: "Accessed page on the website or file" }),
              e.jsx("p", { children: "Browser type and browser version" }),
              e.jsx("p", { children: "Used operating system" }),
              e.jsx("p", { children: "Type of device used" }),
              e.jsx("p", { children: "Website access time" }),
              e.jsx("p", {
                children:
              ...
              e.jsx("p", {
                children:
                  "According to IONOS, the data recorded are completely anonymized so they cannot be tracked back to individuals. IONOS Web Analytics does not archive cookies.",
              }),
              e.jsx("p", {
                children:
              ...
              e.jsx("p", {
                children:
                  "For more information affiliated with the recording and processing of data by IONOS Web Analytics, please click on the following link of the data policy declaration:",
              }),
              e.jsx("p", {
                children: "https://www.ionos.de/terms-gtc/index.php?id=6.",
              }),
              e.jsx("h4", { children: "Contract data processing" }),
              e.jsx("p", {
                children:
              ...
              e.jsx("h4", { children: "Google Remarketing" }),
              e.jsx("p", {
                children:
              ...
              e.jsx("h4", { children: "Google Conversion-Tracking" }),
              e.jsx("p", {
                children:
              ...
              e.jsx("h4", { children: "Facebook Pixel" }),
              e.jsx("p", {
                children:
              ...
              e.jsx("h3", { children: "6. Newsletter" }),
              e.jsx("h4", { children: "Newsletter data" }),
              e.jsx("p", {
                children:
              ...
              e.jsx("h4", { children: "Data processing" }),
              e.jsx("p", {
                children:
              ...
              e.jsx("h4", { children: "Purpose and legal bases" }),
              e.jsx("p", {
                children:
              ...
              e.jsx("h4", { children: "Duration of storage" }),
              e.jsx("p", {
                children:
              ...
              e.jsx("p", { children: "Conference tools used" }),
              e.jsx("p", {
                children: "We employ the following conference tools:",
              }),
              e.jsx("h4", { children: "Zoom" }),
              e.jsx("p", {
                children:
              ...
              e.jsx("h3", { children: "8. Custom Services" }),
              e.jsx("h4", { children: "Job Applications" }),
              e.jsx("p", {
                children:
                  "We offer website visitors the opportunity to submit job applications to us (e.g. via e-mail, via postal services on by submitting the online job application form). Below, we will brief you on the scope, purpose and use of the personal data collected from you in conjunction with the application process. We assure you that the collection, processing and use of your data will occur in compliance with the applicable data privacy rights and all other statutory provisions and that your data will always be treated as strictly confidential.",
              }),
              e.jsx("h4", {
                children: "Scope and purpose of the collection of data",
              }),
              e.jsx("p", {
                children:
              ...
              e.jsx("h4", { children: "Data Archiving Period" }),
              e.jsx("p", {
                children:
              ...
              e.jsx("h4", { children: "Admission to the applicant pool" }),
              e.jsx("p", {
                children:
  ...
  c = () =>
    e.jsxs("div", {
      children: [
        e.jsx(i, {
          children: e.jsx("title", { children: "Nefentus | Privacy" }),
        }),
        e.jsx(r, {}),
      ],
    });
