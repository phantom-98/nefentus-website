...
import { z as d, I as c, O as w } from "./index-d2e049d5.js";
import { R as D } from "./recaptcha-wrapper-bf7eb57d.js";
import { u as L, E as O, t as G } from "./error-409177f8.js";
import { H as k } from "./Helmet-3728875c.js";
import "./hoist-non-react-statics.cjs-6fdb2ae2.js";
const B = "_signup_48gfh_1",
...
function X(s, n, i) {
  ...
  if (Array.isArray(n))
    return n.some((r) => !!(a.hasOwnProperty(r) && a[r].test(s)));
  if (n in a) return a[n].test(s);
  if (!n || n === "any") {
    for (const r in a) if (a.hasOwnProperty(r) && a[r].test(s)) return !0;
    return !1;
  }
...
const ee = () => {
    ...
    const s = u.useRef(),
      ...
      [i, r] = u.useState(null),
      [p, E] = u.useState(null),
      [g, $] = u.useState(n("signUp.option1Placeholder")),
      P = new v(),
      C = d
        .object({
          firstName: d
        ...
        }),
      {
        ...
        reset: y,
        formState: { errors: l },
      } = L({ resolver: G(C), mode: "onSubmit" }),
      I = () => {
        y(), $(n("signUp.option1Placeholder"));
      };
    async function U(m) {
      if (g === n("signUp.option1Placeholder")) {
      ...
      if (!s.current.getValue()) r("Please verify the reCAPTCHA!");
        ...
        (await P.register(T)) == null
          ? r("Error when registering")
          : E("Please confirm your email address to proceed."),
          I(),
          r(null);
      }
    }
      ...
      children: [
        e.jsx("div", {
          ...
          children: e.jsx(j, {
            link: "/",
            color: "white",
            children: n("login.close"),
          }),
        }),
        e.jsxs("div", {
          className: o.left,
          children: [
            e.jsx("img", { src: R, alt: "nefentus logo" }),
            e.jsxs("div", {
              children: [
                e.jsxs("h2", {
                  children: [
                    ...
                    e.jsx("span", {
                      className: "gradient",
                      children: n("signUp.titleP2"),
                    }),
                  ],
                }),
                e.jsx("p", { children: n("signUp.description") }),
                e.jsxs("p", {
                  children: [
                    n("signUp.info"),
                    e.jsx("u", {
          ...
          children: [
            e.jsx(O, {
              error:
                ...
                ((b = l.telNr) == null ? void 0 : b.message) ||
                ((h = l.email) == null ? void 0 : h.message) ||
            ...
            e.jsxs("div", {
              ...
              children: [
                e.jsx(c, {
                  label: n("signUp.firstNameLabel") + "*",
                  placeholder: n("signUp.firstNamePlaceholder"),
                  register: t,
                  name: "firstName",
                }),
                e.jsx(c, {
                  label: n("signUp.lastNameLabel") + "*",
                  placeholder: n("signUp.lastNamePlaceholder"),
                  register: t,
                  name: "lastName",
                }),
                e.jsx(c, {
                  label: n("signUp.telefonLabel"),
                ...
                e.jsx(c, {
                  ...
                  placeholder: n("signUp.passwordPlaceholder"),
                  register: t,
                  name: "password",
                  secure: !0,
                }),
                e.jsx(c, {
                  ...
                  placeholder: n("signUp.confirmPasswordPlaceholder"),
                  register: t,
                  name: "confirmPassword",
                  secure: !0,
                }),
                e.jsx(w, {
                  label: n("signUp.option1Label") + "*",
                  value: g,
                  setValue: $,
                  options: Q,
                }),
            ...
            e.jsx("div", {
              ...
              children: e.jsx(j, {
                className: o.button,
                type: "submit",
                children: n("signUp.formButton"),
              }),
            }),
            e.jsx("p", {
              className: o.formAgreement,
              children: n("signUp.formInfo"),
            }),
          ],
        }),
      ],
