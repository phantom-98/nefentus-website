import { u as y, r as N, j as s, B as j, Q as z } from "./index-80ad4a2a.js";
const k = "_layout_5v4zs_1",
  ...
  G = "/nefentus/assets/google-fa279740.svg",
  q = "/nefentus/assets/apple2-1dffdf27.svg",
  J = "/nefentus/assets/dummy-918cf24b.webp",
  ...
  ss = ({
    ...
    const { t: b } = y(),
      i = b("affiliate.affiliateList", { returnObjects: !0 }),
      u = N.useRef(null),
      W = (X) => {
        if (u.current) {
          const m = u.current.play();
          m !== void 0 &&
            m
              .then(() => {})
              .catch((Y) => {
