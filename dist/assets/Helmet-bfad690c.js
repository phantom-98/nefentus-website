import { C as M, r as te, a3 as I } from "./index-aff6404b.js";
var W = { exports: {} },
  ...
  return function (a) {
    ...
    var c = (function (f) {
      ...
      return (
        ...
        (d.render = function () {
          return ce.createElement(a, this.props);
        }),
        p
      );
    })(X.PureComponent);
    return (
      U(c, "displayName", "SideEffect(" + r(a) + ")"), U(c, "canUseDOM", fe), c
    );
  };
}
var pe = le;
const de = M(pe);
var Te = typeof Element < "u",
  me = typeof Map == "function",
  he = typeof Set == "function",
  ve = typeof ArrayBuffer == "function" && !!ArrayBuffer.isView;
function j(t, e) {
  if (t === e) return !0;
  if (t && e && typeof t == "object" && typeof e == "object") {
    ...
    if (Array.isArray(t)) {
      ...
      for (r = n; r-- !== 0; ) if (!j(t[r], e[r])) return !1;
      return !0;
    }
    var a;
    ...
    if (he && t instanceof Set && e instanceof Set) {
      if (t.size !== e.size) return !1;
      for (a = t.entries(); !(r = a.next()).done; )
        if (!e.has(r.value[0])) return !1;
      return !0;
    }
    if (ve && ArrayBuffer.isView(t) && ArrayBuffer.isView(e)) {
      if (((n = t.length), n != e.length)) return !1;
    ...
    if (Te && t instanceof Element) return !1;
    for (r = n; r-- !== 0; )
      if (
        !(
...
var h = {
        ...
        s.filter(function (d) {
          for (var T = void 0, y = Object.keys(d), E = 0; E < y.length; E++) {
            ...
            n.indexOf(b) !== -1 &&
              ...
              (T = b),
              n.indexOf(A) !== -1 &&
                (A === h.INNER_HTML || A === h.CSS_TEXT || A === h.ITEM_PROP) &&
                (T = A);
          }
          if (!T || !d[T]) return !1;
  ...
  Be = function (e, n) {
    typeof e < "u" && document.title !== e && (document.title = Q(e)),
      D(l.TITLE, n);
  },
  D = function (e, n) {
    ...
    return n.map(function (r, o) {
      ...
      return (
        Object.keys(r).forEach(function (i) {
          var u = N[i] || i;
          if (u === h.INNER_HTML || u === h.CSS_TEXT) {
          ...
          return (
            ...
            (a.prototype.flattenArrayTypeChildren = function (i) {
              ...
              return v(
                ...
                f,
                ((u = {}),
                (u[c.type] = [].concat(f[c.type] || [], [
                  v({}, p, this.mapNestedChildrenToProps(c, d)),
                ])),
                u),
              );
            }),
            ...
            (a.prototype.mapChildrenToProps = function (i, u) {
              var c = this,
                f = {};
              return (
                I.Children.forEach(i, function (p) {
                  if (!(!p || !p.props)) {
                    var d = p.props,
                      T = d.children,
                      y = q(d, ["children"]),
            ...
            (a.prototype.render = function () {
              var i = this.props,
                ...
                f = v({}, c);
              return (
                u && (f = this.mapChildrenToProps(u, f)), I.createElement(e, f)
              );
            }),
            Ie(a, null, [
              {
