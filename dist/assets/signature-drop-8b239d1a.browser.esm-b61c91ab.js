...
import { S as O } from "./erc-721-standard-961fbe42.browser.esm-711a8851.js";
import { P as z } from "./thirdweb-checkout-fbd7e98d.browser.esm-56c824d0.js";
import { l as c, R as D } from "./index-dd74b233.js";
...
const l = class l extends O {
  ...
  async getAllUnclaimed(t) {
    ...
    return await Promise.all(
      Array.from(Array(s.sub(n).toNumber()).keys()).map((h) =>
        this.erc721.getTokenMetadata(n.add(h).toString()),
      ),
    );
  }
