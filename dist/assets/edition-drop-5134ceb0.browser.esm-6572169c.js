...
import { l as P, R as F } from "./index-dd74b233.js";
import { S as x } from "./erc-1155-standard-ab2417d3.browser.esm-c046e185.js";
import { P as _ } from "./thirdweb-checkout-fbd7e98d.browser.esm-56c824d0.js";
...
class q {
  ...
  async getAllClaimerAddresses(a) {
    const t = (await this.events.getEvents("TokensClaimed")).filter((r) =>
      r.data && P.isBigNumber(r.data.tokenId) ? r.data.tokenId.eq(a) : !1,
    );
    return Array.from(
      new Set(
        t
...
const p = class p extends x {
  ...
  async isTransferRestricted() {
    return !(await this.contractWrapper.readContract.hasRole(B("transfer"), F));
  }
