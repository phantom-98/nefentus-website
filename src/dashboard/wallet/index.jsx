        ...
        <div className={styles.center}>
          {metamask.status === "disconnected" && (
            <Button
              ...
              onClick={() => metamask.connect(metamask.config, { chainId: 1 })}
            >
              Connect to MetaMask
            </Button>
          )}
      ...
      <div className={styles.tabContent}>
        ...
        {isMetaMask && metamask.address && (
          <div className={`${styles.metamaskAccount} card`}>
            <span>
              Connected wallet:{" "}
              {`${metamask.address.substring(
                0,
                5,
              )}...${metamask.address.substring(metamask.address.length - 5)}`}
            </span>
            <div
              className={styles.metamaskDisconnectButton}
            ...
            <ModalOverlay>
              <div className={styles.modal}>
                ...
                <TopInfo
                  ...
                  description={
                    "You requested to withdraw funds from your account."
                  }
                />

                <Table
                  data={[
                    ["Amount:", `${withdrawAmount} ${withdrawCurrency}`],
